...
then
    ...
    ${VICE_PATH}/c1541 -attach ${disk} -write hw.prg "hw" -silent
    ${VICE_PATH}/c1541 -attach ${disk} -write hwlow.prg "hwlow" -silent
    ...
    ${VICE_PATH}/c1541 -attach ${disk} -write hand.koa "hand.koa" -silent
